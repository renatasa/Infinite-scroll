...
const createPhotoStreamComponent=(expectedState)=>{
  ...
  return expectedState ? wrapper.setState(expectedState) : findByTestAttr(wrapper, "component-PhotoStream")
}
...
test("When app is loading, then Spinner is shown instead of PhotoStream", () => {
  ...
  const error= findByTestAttr(wrapperPhotoStream, "component-PhotoStreamError")
